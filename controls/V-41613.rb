...
rules invoked.
  ...
  If the 'log_format' directive is not configured to contain the '$time_local' variable, this is a finding. 
  "
  desc  "fix", "Configure the 'log_format' directive in the nginx.conf to use the '$time_local' variable to 
  log date and time with the event."
